...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      increment: (...args_1) => {
        ...
        const increment_by_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('increment',
                                     'argument 1 (as invoked from Typescript)',
                                     'counter.compact line 14 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(increment_by_0) === 'bigint' && increment_by_0 >= 0n && increment_by_0 <= 4294967295n)) {
          __compactRuntime.typeError('increment',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(increment_by_0),
  ...
  _increment_0(context, partialProofData, increment_by_0) {
    const tmp_0 = ((t1) => {
                    if (t1 > 4294967295n) {
                      throw new __compactRuntime.CompactError('counter.compact line 15 char 24: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 4294967295');
                    }
                    return t1;
